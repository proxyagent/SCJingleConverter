...
I have had a chance to launch the exe on Windows 11, although elements of the GUI are offset. Everything is still fairly readable and you can still easily understand what does what. I have not been able to test further than launching the exe. I will have more time later this week to see if the application functions as it is intended too.
